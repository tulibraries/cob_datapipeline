...
CATALOG_HARVEST_FROM_DATE = "{{ var.value.CATALOG_PROD_HARVEST_FROM_DATE }}"
CATALOG_LAST_HARVEST_FROM_DATE = "{{ var.value.CATALOG_PROD_LAST_HARVEST_FROM_DATE }}"
S3_NAME_SPACE = '{{ logical_date.strftime("%Y-%m-%d_%H-%M-%S") }}'
DEFAULT_HARVEST_UNTIL_DATE = '{{ logical_date.strftime("%Y-%m-%dT%H:%M:%SZ") }}'
CATALOG_HARVEST_UNTIL_DATE = "{{ var.value.get('CATALOG_PROD_HARVEST_UNTIL_DATE', logical_date.strftime('%Y-%m-%dT%H:%M:%SZ')) }}"
...
COB_INDEX_VERSION = "{{ var.value.PROD_COB_INDEX_VERSION }}"
