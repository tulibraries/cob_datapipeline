"""TU Libraries Airflow Script for Harvesting Records from Alma OAI Endpoint."""
...
#pylint: disable=R0914,R0915,R1705
def almaoai_harvest():
    #pylint: disable=missing-docstring,invalid-name, C0301
    """Method to harvest Alma records from Alma's OAI-PMH HTTP Endpoint."""
    try:
