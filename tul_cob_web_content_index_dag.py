...
WEB_CONTENT_INDEX_SCHEDULE_INTERVAL = airflow.models.Variable.get("WEB_CONTENT_INDEX_SCHEDULE_INTERVAL")
#
# CREATE DAG
#
DEFAULT_ARGS = {
...
WEB_CONTENT_DAG = airflow.DAG(
    'tul_cob_web_content_reindex', default_args=DEFAULT_ARGS, catchup=False,
    max_active_runs=1, schedule_interval=WEB_CONTENT_INDEX_SCHEDULE_INTERVAL
)
...
ingest_databases_task = ingest_databases(dag=WEB_CONTENT_DAG, conn=SOLR_CONN)
