"""Controller DAG to trigger sc_az_reindex for Production environment:"""
...
CONTROLLER_DAG = airflow.DAG(
    dag_id="trigger_prod_sc_az_reindex_dag",
    default_args={
        "owner": "cob",
...
PROD_TRIGGER = TriggerDagRunOperator(
    ...
    params={"condition_param": True,
            "message": "Triggering Production Databases (AZ) Index DAG",
            "env": "prod"
           },
    dag=CONTROLLER_DAG
)
