...
def pytest_sessionstart():
    ...
    airflow.models.Variable.set("AZ_SOLR_CONFIG", {"configset": "tul_cob-az-2", "replication_factor": 2}, serialize_json=True)
    airflow.models.Variable.set("BLACKLIGHT_CORE_NAME", "tul_cob-catalog")
    airflow.models.Variable.set("COB_SOLR_CONFIG", {"configset": "tul_cob-catalog-2", "replication_factor": 2}, serialize_json=True)
