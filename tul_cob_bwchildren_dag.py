...
from cob_datapipeline.almaoai_harvest import boundwithchildren_oai_harvest
...
dag = DAG(
    'tul_cob_boundwith_children', default_args=default_args, catchup=False,
...
fetch_children = PythonOperator(
    task_id='fetch_boundwith_children',
    python_callable=boundwithchildren_oai_harvest,
    provide_context=True,
