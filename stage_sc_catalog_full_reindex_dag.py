"""Controller DAG to trigger sc_catalog_full_reindex for Stage environment:"""
...
CONTROLLER_DAG = airflow.DAG(
    dag_id="trigger_stage_sc_catalog_full_reindex_dag",
    default_args={
        "owner": "cob",
...
STAGE_TRIGGER = TriggerDagRunOperator(
    ...
    params={"condition_param": True,
            "message": "Triggering Stage Catalog (TUL COB) Full Reindex DAG",
            "env": "stage"
           },
    dag=CONTROLLER_DAG
)
