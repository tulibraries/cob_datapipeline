...
def pytest_sessionstart():
    ...
    airflow.models.Variable.set("AZ_SOLR_CONFIG_QA", {"configset": "tul_cob-az-1", "replication_factor": 2}, serialize_json=True)
    airflow.models.Variable.set("AZ_SOLR_CONFIG_STAGE", {"configset": "tul_cob-az-1", "replication_factor": 2}, serialize_json=True)
