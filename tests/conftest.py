...
def pytest_sessionstart():
    ...
    airflow.models.Variable.set("ALMASFTP_S3_ORIGINAL_BW_DATA_NAMESPACE", "2020060800")
    ...
    airflow.models.Variable.set("DSPACE_OAI_CONFIG", {"endpoint": "foobar", "md_prefix": "xoai", "setspec": "col_20.500.12613_11"}, serialize_json=True)
